...
void UI::setImageAndWinName( const Mat& _image, const string& _winName  )
{
...
void UI::setLblsInMask( int flags, Point p, bool isPr )
{
...
void UI::mouseClick( int event, int x, int y, int flags, void* )
{
	switch( event )
	{
...
//Execute GrabCut algorithm¡ê?and return the iter count.
int UI::nextIter()
{
	if( isInitialized )
