...
const int BGD_KEY = cv::EVENT_FLAG_CTRLKEY;// When press "CTRL" key,the value of flags return.
const int FGD_KEY = cv::EVENT_FLAG_SHIFTKEY;// When press "SHIFT" key, the value of flags return.
